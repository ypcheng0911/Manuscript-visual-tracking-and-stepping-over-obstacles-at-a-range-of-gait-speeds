...
model = YOLO("<path_to_model>\\my_model.pt")

# Retrive all video paths
path = "<path_to_raw_data>\\Eye tracking raw data\\N02\\Data\\Media"
path_len = len(path)
file_names = []
video_paths = []
...
save_path = "<path_to_processed_data>\\Eye_tracking_videos\\N02\\with_videos"
